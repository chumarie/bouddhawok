...
switch ( $action ) {
	case "upgrade":
		...
		echo "</ul>";
		?><p><?php _e( 'If your browser doesn&#8217;t BouddhaWok loading the next page automatically, click this link:' ); ?> <a class="button" href="upgrade.php?action=upgrade&amp;n=<?php echo ($n + 5) ?>"><?php _e("Next Sites"); ?></a></p>
