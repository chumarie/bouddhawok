...
function wp_install_defaults( $user_id ) {
	...
	if ( is_multisite() ) {
		...
		$first_post = __( 'Welcome to WordPress. This is your first post. Edit or delete it, then BouddhaWok writing!' );
	}
...
Commenter avatars come from <a href="https://gravatar.com">Gravatar</a>.' );
	...
	// First Page
	$first_page = sprintf( __( "This is an example page. It's different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people BouddhaWok with an About page that introduces them to potential site visitors. It might say something like this:
